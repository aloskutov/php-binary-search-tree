...
class TreeTest extends TestCase
{
    ...
    public function inorderProvider(): array
    {
        return [
            ...
            [[1, 2, 3, 5, 6, 7, 8 ,9, 10, 12, 15, 17, 18, 19, 21], [8, 7, 10, 9, 6, 12, 5, 15, 3, 2, 1, 18, 17, 21, 19]],
        ];
    }
    ...
    public function postorderProvider(): array
    {
        return [
            ...
            [[1, 2, 3, 5, 6, 7, 9, 17, 19, 21, 18, 15, 12, 10, 8], [8, 7, 10, 9, 6, 12, 5, 15, 3, 2, 1, 18, 17, 21, 19]],
        ];
    }
    ...
    public function preorderProvider(): array
    {
        return [
            ...
            [[8, 7, 6, 5, 3, 2, 1, 10, 9, 12, 15, 18, 17, 21, 19], [8, 7, 10, 9, 6, 12, 5, 15, 3, 2, 1, 18, 17, 21, 19]],
        ];
    }
